...
?>  
    ...
    <body style="background: #f1f1f1">
      ...
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div class="lh-100">
          <h1 class="mb-0 text-white lh-100">ForAD</h1>
          <small>Comunica Tus Ideas</small>
        </div>
      </div>

      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h5 class="border-bottom border-gray pb-2 mb-0">Top Categorias</h5>
        ...
        <?php
            ...
            if ($_SESSION['userLevel'] == 1)
            {
                echo '<small class="d-block text-right mt-3">
                        <a href="create-category.php" class="btn btn-primary">Crear Categoria</a>';
            }
            else
            {
                echo '<small class="d-block text-right mt-3">';
        ...
        ?>
            ...
            <a href="categories.php" class="btn btn-primary">Todas las Categorias</a>
        </small>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h5 class="border-bottom border-gray pb-2 mb-0">Top Foros</h5>
        ...
        <small class="d-block text-right mt-3">
            <a href="create-topic.php" class="btn btn-primary">Crear Foro</a>
            <a href="topics.php" class="btn btn-primary">Todos los Foros</a>
        </small>
