        ...
        <main role="main" class="container">
            <div class="mx-5">
                <div class="d-flex align-items-center p-3 my-3 mx-5 text-white-50 bg-purple rounded shadow-sm">
                  ...
                  <div class="lh-100">
                    <h1 class="mb-0 text-white lh-100">Usuarios AD</h1>
                    <small>Publica tus Ideas</small>
                  </div>
                </div>

                <div class="my-3 mx-5 p-3 bg-white rounded shadow-sm">
                  <h5 class="border-bottom border-gray pb-2 mb-0">Encuentra Personas</h5>
                  ...
                  ?>
                      ...
                      <small class="d-block text-right mt-3">
                          <a href="profile.php" class="btn btn-primary">Ir al perfil</a>
                          <a href="message.php" class="btn btn-primary">Ir a Inbox</a>
                      </small>
