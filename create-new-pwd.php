...
?>  
    ...
    <body style="background: url('img/cover2.png');">
      ...
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div class="lh-100">
          <h1 class="mb-0 text-white lh-100">Restrablecer Contraseña</h1>
        </div>
      </div>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm text-center">
        ...
        <p class="text-secondary">Cree una nueva contraseña para acceder a su cuenta</p>
        <br>
        ...
        <?php
            ...
            {
                echo "<h5 class='text-danger'>No se pudo validar su solicitud!</h5>";
            }
            else
            {
        ...
        ?>
                    ...
                    <form action="includes/reset-password.inc.php" method="post" id="contact-form">
                        ...
                        <div class="form-row">
                            <div class="col">
                              <input class="form-control" type="password" name="pwd" placeholder="Introduzca una nueva contraseña">
                            </div>
                            <div class="col">
                              <input class="form-control" type="password" name="pwd-repeat" placeholder="Confirme su nueva contraseña">
                            </div>
                        </div>
                        <br><br>
                        <div class="form-row">
