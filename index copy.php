...
?> 
    ...
    <body onload="pageLoad()">
        ...
        <img src='img/500a.png' id='loader-logo'>
            <div class="loader">
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active" id="forum-tab" data-toggle="tab" href="#forum" role="tab" 
                                 aria-controls="forum" aria-selected="true">Foros Recientes</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="blog-tab" data-toggle="tab" href="#blog" role="tab" 
                                 aria-controls="blog" aria-selected="false">Blog Rcientes</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="poll-tab" data-toggle="tab" href="#poll" role="tab" 
                                 aria-controls="poll" aria-selected="false">Encuestas Recientes</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="event-tab" data-toggle="tab" href="#event" role="tab" 
                                 aria-controls="event" aria-selected="false">Eventos Recientes</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="blog" role="blog" aria-labelledby="blog-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/200.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-white lh-100">Ultimos Blogs</h1>
                                  </div>
                                </div>  
                            ...
                            <div class="tab-pane fade" id="poll" role="poll" aria-labelledby="poll-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/200.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-white lh-100">Ultimas Encuestas</h1>
                                  </div>
                                </div>  
                            ...
                            <div class="tab-pane fade" id="event" role="event" aria-labelledby="event-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/200.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-white lh-100">Proximos Eventos</h1>
                                  </div>
                                </div>  
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="forum.php" class="btn btn-warning btn-lg btn-block">Foro</a>
                        ...
                        <a href="create-blog.php" class="btn btn-secondary btn-lg btn-block">CREAR BLOG</a>
