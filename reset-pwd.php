    ...
    <body style="background: url('img/cover2.png');">
        ...
        <main role="main" class="container">
            ...
            <div class="d-flex align-items-center mt-5 p-3 text-white-50 bg-purple rounded shadow-sm">
              ...
              <div class="lh-100">
                <h1 class="mb-0 text-white lh-100">Restablecimiento de contraseña</h1>
              </div>
            </div>

            <div class="my-3 p-3 bg-white rounded shadow-sm text-center">

              <h1 class="text-primary">Restablecer su contraseña</h1>
              <p class="text-secondary">Se le enviará un correo electrónico con instrucciones sobre cómo restablecer su contraseña</p>
              <br>
              ...
              <?php
                  if(isset($_GET['reset']))
                  {
                      ...
                      {
                          echo '<h4 class="text-success">Consultar su correo electrónico!</h4>';
                      }
                  }
              ?>
              ...
              <form action="includes/reset-request.inc.php" method="post">
                  ...
                  <div class="form-row">
                      <div class="col">
                        <input class="form-control" type="email" name="email" placeholder="Correo electrónico de su cuenta">
                      </div>
                      <div class="col">
                        <input class="btn btn-secondary btn-block" type="submit" class="button next" name="reset-request-submit" 
                         value="Recibir nueva contraseña por correo electrónico">
                      </div>
                  </div>
              </form>
            </div>
